...
export const VehiclesDetails = () => {
    ...
    return (
        <>
            ...
            {!!vehicles ? vehicles.filter((_elem, index) => index == position).map(({ name,model,manufacturer,cost_in_credits,length,max_atmosphering_speed,crew,passengers,cargo_capacity,consumables,vehicle_class }) => {
                return (
